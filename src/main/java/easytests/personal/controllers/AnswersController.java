...
public class AnswersController extends AbstractCrudController {
    ...
    */
    ...
    public String deleteConfirmation(
            ...
            @PathVariable("topicId") Integer topicId) {
        final QuestionModelInterface questionModel = getQuestionModel(questionId, false);
        final AnswerModelInterface answerModel = getAnswerModel(answerId, questionId);
        model.addAttribute("answer", answerModel);
        model.addAttribute("questionId", questionId);
        model.addAttribute("question_txt", questionModel.getText());
        model.addAttribute("topicId", topicId);
    ...
    public String delete(
            ...
            @PathVariable("questionId") Integer questionId,
            @PathVariable("topicId") Integer topicId) {
        final QuestionModelInterface questionModel = getQuestionModel(questionId, true);
        final AnswerModelInterface answerModel = getAnswerModel(answerId, questionId);
        answersService.delete(answerModel);
        return "redirect:/personal/topics/" + topicId + "/questions/" + questionId + "/update_answers";
    }
    /*
